      ...
      <v-container class="fill-height" fluid>
        ...
        >
          ...
          <v-spacer></v-spacer>
                    ...
                    <v-card-text class="text-h6" >Mascobe</v-card-text>
                    <v-progress-linear
                      background-color="#F7F8F8"
                      height=10
                      rounded
                    ...
                    <v-card-text class="text-h6" >Ogljikovi hidrati</v-card-text>
                    <v-progress-linear
                      background-color="#F7F8F8"
                      height=10
                      rounded
...
<script>
  export default {
    data: () => ({
      ...
      events: [],
      colors: ['#00A99D'],
      names: ['Medena palacinka', 'Kava', 'Piscancji zrezek', 'Mleko', 'Pomorance', 'Jabolcna pita', 'Solata', 'Ovsena kasa'],
